...
// Prototype-only password gate. Replace with real authentication
// (e.g. a login API + hashed passwords + sessions) when a backend exists.
const NR_ADMIN_PASSWORD = "naija2026";
